...
*
* @package	  ORM
* @author	  Kohana Team, upravil Ondrej Novak
...
class ORM_List implements Iterator, ArrayAccess, Countable, IDataSource {
	 ...
	 * @return	array
	 */
	public function as_list($key = NULL, $val = NULL)
	{
		if ($key === NULL)
		{
			// Use the default key
