...
class NetteLoader extends AutoLoader
{
	...
	public $list = array(
		...
		'databasejournal' => '/Caching/DatabaseJournal.php',
		'filestoragewithdatabasejournal' => '/Caching/FileStorageWithDatabaseJournal.php',
		'database' => '/../Database/Database.php',
		'database_mysql_driver' => '/../Database/Mysql.php',
		'database_driver' => '/../Database/Database.driver.php',
		'string' => '/VA/String.php',
		...
		'user' => '/Web/User.php',
		'ipenvdetector' => '/../Tools/IpEnvDetector.php',
	);
