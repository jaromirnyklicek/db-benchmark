...
final class String
{
	...
	public static function trim($s, $charlist = " \t\n\r\0\x0B\xC2\xA0")
	{
		...
		/**
	 * Universal function converting HTML to plain text.
	 *
	 * @param $input string    HTML
	 * @return string
	 *
	 */
	public static function html2plain($input, $url = ''){
		$html = new Html2Text($input);
		if(!empty($url)) $html->set_base_url($url);
	...
	*/
	...
	{
		return /*Nette\Templates\*/TemplateHelpers::bytes($bytes, $precision);
	}

	public static function removeDiacritic($s)
	{
