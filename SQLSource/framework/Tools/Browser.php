...
/**
* Trida pro zjisteni vlastnosti prohlizece
*
...
*
*
* 20.08.2009 - Igor Lamos <igor.lamos@viaaurea.cz>
* - replaced ereg(i) / preg_match and ereg_replace / preg_replace
*	(ereg function are deprecated in PHP 5.3)
*
*/
...
class Browser
{
		...
		/**
		* stahnuto z http://mobiforge.com/developing/story/lightweight-device-detection-php
		*
		*/
