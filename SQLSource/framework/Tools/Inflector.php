...
/**
* Inflector for plural and singular English nouns.
* 
...
class Inflector
{
	...
	/**
	* plurals English nouns.
	* 
	* @access public
	* @static
	* @param	string	  $word    English noun to plural
	...
	*/
	...
	/**
	* singulars English nouns.
	* 
	* @access public
	* @static
	* @param	string	  $word    English noun to singular
	...
	*/
	...
	{
		return Inflector::plural(Inflector::underscore($class_name));
	}
	...
	*/
	...
	{
		return Inflector::camelize(Inflector::singular($table_name));
	}
